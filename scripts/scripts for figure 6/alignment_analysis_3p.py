...
"""
Figure 6A reproducibility script
================================
...
Figure 6A of the manuscript. It analyzes a multiple sequence alignment
of mature human miR-548-3p sequences and calculates positional sequence
variability metrics.
...
5–11 (alignment-normalized positions)

Input
-----
FASTA multiple sequence alignment of mature miR-548-3p sequences.
...
alignment_analysis_5p.py and figure6_reproducibility.R, it enables
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyze sequence conservation and entropy from a multiple sequence alignment."
    )
    ...
    parser.add_argument(
        "--output",
        default=Path("sequence_analysis_results.csv"),
        type=Path,
